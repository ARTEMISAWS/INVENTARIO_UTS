                        ...
                        @foreach($categorias as $categoria)
                            <div class="mb-2">
                                <button @click="activeAccordion = (activeAccordion === {{ $categoria->id }} ? null : {{ $categoria->id }})" 
                                    ...
                                    <svg :class="activeAccordion === {{ $categoria->id }} ? 'rotate-180' : ''" class="w-4 h-4 transform transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
                                </button>
