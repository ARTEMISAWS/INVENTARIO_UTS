        ...
        <div class="sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="mb-6">
                        <form action="{{ route('categorias.index') }}" method="GET" class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                            <div class="flex items-center w-full md:w-auto">
                                ...
                                @if(request('search'))
                                <a href="{{ route('categorias.index') }}" class="p-2.5 ml-2 text-sm font-medium text-gray-700 bg-gray-200 rounded-lg hover:bg-gray-300 text-center">
                                    Limpiar
                                </a>
                                @endif
                            </div>
                        ...
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                                ...
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                    ...
                                    <td class="px-6 py-4">{{ $categoria->cantidad ?? 0 }}</td>
                                    <td class="px-6 py-4 flex items-center space-x-2">
                                        <a href="{{ route('categorias.edit', $categoria) }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">
                                ...
                                @empty
                                <tr>
                                    <td colspan="5" class="px-6 py-4 text-center">No hay categorías registradas.</td>
                                </tr>
                                @endforelse
                            </tbody>
                        </table>
